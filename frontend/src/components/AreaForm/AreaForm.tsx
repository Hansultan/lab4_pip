...
export class AreaForm extends React.Component<AreaFormProps, AreaFormState> {
    ...
    private static errorMessages = {
        y: 'Y должен быть числом и входить в интервал (-5, 5)'
    };

    private static availableX = [-4, -3, -2, -1, 0, 1, 2, 3, 4].reduce((acc, cur) => ({ ...acc, [cur]: cur }), {});
    private static availableR = [-4, -3, -2, -1, 0, 1, 2, 3, 4].reduce((acc, cur) => ({ ...acc, [cur]: cur }), {});
        ...
        return (
            <div className="area-form">
                <form onSubmit={this.onSubmit}>
                    ...
                    <NumberField label="Параметр Y:" hint="(-5, 5)" value={y} maxLength={16}
